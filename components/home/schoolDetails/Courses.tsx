...
export const data = [
  ...
  },
  {
    id: "2",
    image: Asset.fromModule(
      require("@/assets/images/schoolDetailsPage/courses/image-2.png")
    ).uri,
  ...
  },
  {
    id: "3",
    image: Asset.fromModule(
      require("@/assets/images/schoolDetailsPage/courses/image-3.png")
    ).uri,
    courseTitle: "Become a Berliner Berghain Bouncer",
    courseDesciption:
      "Castle Crawl: Master German & conquer medieval fortresses",
  },
  {
    id: "4",
    image: Asset.fromModule(
      require("@/assets/images/schoolDetailsPage/courses/image-4.png")
    ).uri,
