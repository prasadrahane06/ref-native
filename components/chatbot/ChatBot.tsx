// // use  import { ChatBot } from "at-chatbot-native";
...
//     ViewStyle,
// } from "react-native";
// import { post, get } from "@/app/services/botAxiosClient";
// import { socket } from "@/webSocket/socket";
// // import useAxiosClient, { socket } from "../services/botClient";
...
//     // const { botPost, botGet } = useAxiosClient();
...
//                 <Text style={{ fontSize: 20, fontWeight: "bold" }}>No Students Found</Text>
//             </View>
//         );
...
//                                     {item?.participants[0]?.name?.split(" ")[0][0].toUpperCase()}
//                                 </Text>
//                             </View>
...
// const ChatBot: React.FC<ChatBotProps> = ({ consumerId, user, config, widgetStyle }) => {
//     const [modalVisible, setModalVisible] = useState(false);
...
//                 <Image
//                     source={{
//                         uri: Asset.fromModule(require("../../assets/images/chat_logo.png")).uri,
//                     }}
