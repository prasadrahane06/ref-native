...
export default function HomeScreen() {
  ...
  const Flag = ({ countryName, countryCode, isSelected, onSelect }: any) => (
    <TouchableOpacity onPress={onSelect}>
      ...
      >
        <AUIThemedView
          style={[styles.flagImageContainer, isSelected && styles.selectedFlag]}
        >
          <Image
            source={{
  ...
  const LastChance = ({ title, subTitle }: any) => (
    <AUIThemedView style={styles.schoolContainer}>
      <AUIThemedView style={styles.lastChanceItem}>
        <LinearGradient
          colors={["rgba(91, 216, 148, 0.8)", "rgba(91, 216, 148, 1)"]}
          style={styles.gradient}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 0 }}
        />
  ...
  return (
    <ScrollView>
      <AUIThemedView>
        ...
        <AUIThemedView style={{ paddingHorizontal: 15, paddingTop: 15 }}>
        ...
        <AUIThemedView>
          <AUIThemedView style={styles.popularTitle}>
            <AUIThemedText style={styles.title}>Popular Schools</AUIThemedText>
        ...
        <AUIThemedView style={{ paddingHorizontal: 10, paddingTop: 15 }}>
          <AUIThemedText style={styles.title}>
