...
import { APP_THEME, COLOR_THEME } from "@/constants/Colors";
import {
  AntDesign,
  EvilIcons,
  FontAwesome,
...
import {
  purchaseCoursesData,
  similarCoursesData,
} from "@/constants/dummy data/similarCoursesData";
...
const CoursesScreen = () => (
  ...
  >
    ...
    <Tab.Screen
      name="Seat Booking"
      component={() => (
        <PurchaseCoursesList data={purchaseCoursesData} seatBooking />
      )}
    />
    <Tab.Screen
      name="Completed Courses"
      component={() => (
        <PurchaseCoursesList data={purchaseCoursesData} completedCourse />
      )}
    />
  </Tab.Navigator>
);
