  ...
  return (
    <View style={styles.drawerContent}>
      ...
      >
        ...
        <AUIThemedText style={styles.menuText}>Change Password</AUIThemedText>
      </TouchableOpacity>
      <View style={styles.separator} />
      <TouchableOpacity
        style={styles.menuItem}
      ...
      >
        ...
        <AUIThemedText style={styles.menuText}>Terms and Policy</AUIThemedText>
      </TouchableOpacity>
      <View style={styles.separator} />
      <TouchableOpacity
        style={styles.menuItem}
        ...
        {isLoggedIn ? (
          ...
          <AUIThemedView style={styles.signUpLiginButtonContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {}}
            >
              <AUIThemedText style={styles.logIntText}>Log In</AUIThemedText>
            </TouchableOpacity>
          </AUIThemedView>
        )}
      </View>
