...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/..\components\common\AUIInputField` | `/..\components\common\AUISecondaryButton` | `/..\components\common\AUISplitOTPInput` | `/_sitemap` | `/cart` | `/compare` | `/courses` | `/facilities` | `/favourite` | `/help` | `/login` | `/school` | `/signup` | `/student`;
